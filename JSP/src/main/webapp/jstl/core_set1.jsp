...
<!-- 0927 (1) -->
			...
			<%
				...
				// jspl과 el 비교 https://hunit.tistory.com/203
				int num1 = 100;
				int num2 = 200;
				int sum = num1 + num2;
			%>
...
<%-- 			<c:out value="num3"/> <!--  출력 : 100이 아닌 num3가 출력됨 --> --%>
...
<%-- 			<c:set var="price" value="200" scope="request"/> --%>
				<c:set var="price" value="300" scope="session"/> <!-- session정보에 담긴것 forward해도 다 넘겨짐. forward는 page를 제외한 모든것 다 넘겨줌 
